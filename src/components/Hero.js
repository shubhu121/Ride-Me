  ...
  return (
    <div className="bg-gray-900 min-h-screen flex flex-col items-center justify-center">
      ...
      <div className="p-6 border border-gray-800 rounded-lg max-w-sm bg-gray-800 text-gray-800 relative">
        ...
        <img src={Logo} alt="Ride Me Logo" className="w-50 h-50 mb-4" />
        <h1 className="text-4xl font-bold text-center mb-6 text-yellow-600">Welcome to Ride Me</h1>
